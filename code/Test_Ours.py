...
if __name__ == '__main__':
    model_base_path = 'pretrained_model'
    model_mode = 'model_indoor'
    display_mode = 'display_indoor'
    test_dataset = 'indoor_test'

    parser = argparse.ArgumentParser(description='PyTorch Template')
    parser.add_argument('-r', '--resume', default='./result/' + model_base_path + '/' + model_mode + '/checkpoint.pth', type=str)

    parser.add_argument('-f', '--data', default='./data/dataset_voxel_0717/' + test_dataset + '/', type=str)

    parser.add_argument('-s', '--save', default='./result/' + model_base_path + '/' + display_mode + '/', type=str)
    parser.add_argument('-b', '--batch_size', default=1, type=str)
    config = parser.parse_args()

    display_path = './result/' + model_base_path + '/' + display_mode
